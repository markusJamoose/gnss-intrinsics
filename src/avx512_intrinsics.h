 ...
 * intrinsic and generates the carrier as si32 type.
 ...
 *  \param[in] samp_freq Sampling frequency of the signal to be generated
 */
void avx512_nom_nco_si32(int *sig_nco, const int *LUT, const int blksize,
...
void avx512_nom_code_si32(int *ecode, int *pcode, int *lcode, const int *cacode,
                          const int blksize, const double remCodePhase,
                          const double codeFreq, const double sampFreq) {
...
void avx512_code_si32(int *ecode, int *pcode, int *lcode, const int *cacode,
                      const int blksize, const float remCodePhase,
                      const float codeFreq, const float sampFreq) {
