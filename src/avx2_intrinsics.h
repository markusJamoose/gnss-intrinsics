 ...
 *  \param[in] blksize Source vector with factors to multiply
 *  \param[in] remCodePhase Number of points to Multiply in the operation
 *  \param[in] codeFreq Number of points to Multiply in the operation
 *  \param[in] carrFreq Number of points to Multiply in the operation
 */
