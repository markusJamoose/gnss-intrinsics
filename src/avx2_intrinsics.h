 ...
 * intrinsic \param[out] sig_nco Sinusoidal wave generated byt the NCO
 ...
 * Prompt CA code \param[out] lcode Late CA code \param[in] lut Lookup table to
 * be use for the code \param[in] blk_size Total number of elements in the
...
/*!
 *  \brief Generates an Early, Late and Propmt CA code based on the direct
 * lookup table approach with SIMD instructions \param[out] ecode Early CA code
 *  \param[out] pcode Prompt CA code
 *  \param[out] lcode Late CA code
 *  \param[in] lut Lookup table to be use for the code
 *  \param[in] blk_size Total number of elements in the sig_nco vector
 *  \param[in] rem_code_phase Carrier phase remainder of the sinusoidal wave to
 * be generated \param[in] code_freq Carrier frequency of the sinusoidal wave
 *  \param[in] samp_freq Sampling frequency of the signal to be generated
 */
