...
for i in range(0,50):
    ...
    output = subprocess.check_output("""/opt/intel/vtune_amplifier_2018.1.0.535340/bin64/amplxe-cl -collect hotspots -quiet -knob sampling-interval=1 -app-working-dir /home/gnssi9/GNSS_tracking_code/standalone_C_program -- /home/gnssi9/GNSS_tracking_code/standalone_C_program/a.out""", shell=True)
