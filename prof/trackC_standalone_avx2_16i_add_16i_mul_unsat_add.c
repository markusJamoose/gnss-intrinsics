...
int main(){
  ...
  getcaCodeFromFile("data/caCode.bin", caCode);
	...
	FILE *fp = fopen("plot/data_avx2_16i_add_16i_mul_unsat_add/I_E_output.bin","wb");
...
//compile: gcc -g -mavx -march=haswell trackC_standalone_avx2_16i_add_16i_mul_unsat_add.c -lm
