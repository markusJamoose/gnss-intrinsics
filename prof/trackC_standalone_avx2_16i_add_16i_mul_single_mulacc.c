/*!
 *  \file trackC_standalone_avx2_16i_add_16i_mul_single_mulacc.c
...
ranging code using AVX2 SIMD intrinsics with si16 types and saturation math.
...
$ gcc -I ../src/ trackC_standalone_avx2_16i_add_16i_mul_single_mulacc.c -g
 -mavx2 -lm -o avx_si16_mulacc -O3
 *  \endcode
 */
...
int main() {
  ...
  printf("  [Logging data into the "
         "'plot/data_avx2_16i_add_16i_mul_single_mulacc' directory]\n");
...
// compile: gcc -g -mavx -march=haswell
// trackC_standalone_avx2_16i_add_16i_mul_single_mulacc.c -lm
