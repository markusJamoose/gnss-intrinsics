/*!
 *  \file trackC_standalone_avx2_32i_add_mul_nom_lut_code.c
...
$ gcc -I ../src/ trackC_standalone_avx2_32i_add_mul_nom_lut_code.c -g
 -mavx2 -lm -o avx2_si32_nom_lut_code -O3
 *  \endcode
 */
...
int main() {
  ...
  int sec_count = 0;
  printf("\n*** Running: trackC_standalone_avx2_32i_add_mul_nom_lut_code "
         "***\n");
  ...
  printf("  [Logging data into the "
         "'plot/data_avx2_32i_add_mul_nom_lut_code' directory]\n");
