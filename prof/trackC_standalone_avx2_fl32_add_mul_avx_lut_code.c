...
int main() {
  ...
  int sec_count = 0;
  printf("\n*** Running: trackC_standalone_avx2_fl32_add_mul_avx_lut_code "
         "***\n");
  for (loopcount = 0; loopcount < codePeriods; loopcount++) {
    ...
    avx2_nco_fl32(cos_avx_si32, cos_LUT_fl32, blksize, remCarrPhase, carrFreq,
                  samplingFreq);

    avx2_code_fl32(eCode_avx_vec, pCode_avx_vec, lCode_avx_vec, caCode, blksize,
    ...
    // I_E
    double I_E =
        avx2_mul_and_acc_fl32(eCode_avx_vec, mixedcarrSin_vec, blksize);

    // I_L
    double I_L =
        avx2_mul_and_acc_fl32(lCode_avx_vec, mixedcarrSin_vec, blksize);

    // I_P
    double I_P =
        avx2_mul_and_acc_fl32(pCode_avx_vec, mixedcarrSin_vec, blksize);

    // Q_E
    double Q_E =
        avx2_mul_and_acc_fl32(eCode_avx_vec, mixedcarrCos_vec, blksize);

    // Q_L
    double Q_L =
        avx2_mul_and_acc_fl32(lCode_avx_vec, mixedcarrCos_vec, blksize);
  ...
  printf("  [Logging data into the "
         "'plot/data_avx2_fl32_add_mul_avx_lut_code' directory]\n");
  // Clearing unused variables for logging operations
  write_file_fl64(
      "../plot/data_avx2_fl32_add_mul_avx_lut_code/codeNco_output.bin",
      codeNco_output);
  write_file_fl64(
      "../plot/data_avx2_fl32_add_mul_avx_lut_code/codeError_output.bin",
      codeError_output);
  write_file_fl64(
      "../plot/data_avx2_fl32_add_mul_avx_lut_code/carrNco_output.bin",
      carrNco_output);
  write_file_fl64(
      "../plot/data_avx2_fl32_add_mul_avx_lut_code/carrError_output.bin",
      carrError_output);
  write_file_fl64(
      "../plot/data_avx2_fl32_add_mul_avx_lut_code/absoluteSample_output.bin",
      absoluteSample_output);
  write_file_fl64(
      "../plot/data_avx2_fl32_add_mul_avx_lut_code/carrFreq_output.bin",
      carrFreq_output);
  write_file_fl64(
      "../plot/data_avx2_fl32_add_mul_avx_lut_code/codeFreq_output.bin",
      codeFreq_output);
  write_file_fl64("../plot/data_avx2_fl32_add_mul_avx_lut_code/I_E_output.bin",
                  I_E_output);
  write_file_fl64("../plot/data_avx2_fl32_add_mul_avx_lut_code/I_P_output.bin",
                  I_P_output);
  write_file_fl64("../plot/data_avx2_fl32_add_mul_avx_lut_code/I_L_output.bin",
                  I_L_output);
  write_file_fl64("../plot/data_avx2_fl32_add_mul_avx_lut_code/Q_E_output.bin",
                  Q_E_output);
  write_file_fl64("../plot/data_avx2_fl32_add_mul_avx_lut_code/Q_P_output.bin",
                  Q_P_output);
  write_file_fl64("../plot/data_avx2_fl32_add_mul_avx_lut_code/Q_L_output.bin",
                  Q_L_output);
