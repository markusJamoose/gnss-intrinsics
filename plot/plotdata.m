function [] = plotdata()
%function [] = plotdata(test_file);
%
% A simple routine to plot the 6 raw array values which are generated by the lab4 program
% This should provide insight into the approximate scales and ranges of the values
% computed (which may aid in optimization).  Also a second figure is generated which
% illustrates the 'more interesting' results of the program
%
% Sample Matlab command line run :
%       plotdata('output.bin');

% A matlab mfile to plot the 'interesting' output results of
% the C optimization lab for SMD077 - 1999
